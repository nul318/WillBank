...
import com.nmsohn.willbank.MainActivity;
import com.nmsohn.willbank.R;
/**
 * (IMPORTANT!)
 * Chart library contributed by PhilJay
 * For documentation, please find the link below:
 * MPAndroidChart
 * https://github.com/PhilJay/MPAndroidChart/wiki
 *
 * Progress bar customized by akexorcist
...
public class HomeFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //progress bar
        RoundCornerProgressBar progress = (RoundCornerProgressBar) findViewById(R.id.completion);
